...
public class PrivilegeGroup  implements Serializable{
	...
	public PrivilegeGroupkey getKey() {
		return key;
	}


	public void setKey(PrivilegeGroupkey key) {
		this.key = key;
	}
...
@Embeddable
class PrivilegeGroupkey implements Serializable {
	...
	PrivilegeGroupkey(){}
	public PrivilegeGroupkey(Integer  module,String PrivilegeGroupCode) {
		this.module=module;
