...
public interface PrivlegeGroupService {

	ValidationForm savePrivilegeGroup(PrivilegeTypeForm form) throws PrevilegeException, BussinessException, BusinessViolatonException;
